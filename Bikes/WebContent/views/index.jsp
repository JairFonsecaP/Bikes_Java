...
<body>
		...
		<div id="carouselExampleCaptions" class="carousel slide"
			...
			<div class="carousel-inner">
				...
				<c:forEach var="product" items="${TOP3_LIST}">
					...
					<div
						class="carousel-item <c:if test="${product.id eq TOP3_LIST[0].id}">active</c:if>">
						...
						<div class="carousel-caption d-none d-md-block">
							...
							<a href="${tempLink}" type="button" class="btn btn-primary">See
								bike</a>
						</div>
					</div>
				</c:forEach>
				...
				<div class="col">
					<div class="card h-100">
						...
						<div class="card-footer">
							...
							<a href="${tempLink}" class="btn btn-primary">See all
								products</a>
						</div>
					</div>
				</div>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<c:choose>
		<c:when test="${confimationPurchase}">
			<script>
